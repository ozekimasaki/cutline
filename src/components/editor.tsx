...
export function Editor() {
  ...
  const start = useCallback(
    async (mode: "cameras" | "short-talk" | "files") => {
      const useSample = mode !== "files";
      setActionError(null);
      setEditedUrl(null);
